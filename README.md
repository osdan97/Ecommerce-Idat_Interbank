...
GET
localhost:8080/api/authentication/authentication/verify/{verificationCode}

Example input:

localhost:8080/api/authentication/verify/BFhUIMZCvLaRGRKAC9g9LqltlXLqzqopJiSY1G2BevotUt6YsfjKtigeUI2mqzSh
